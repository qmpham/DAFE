...
from layers.layers import Regulation_Gate, Multi_domain_FeedForwardNetwork, Multi_domain_Gate_v2, Multi_domain_FeedForwardNetwork_v2, DAFE, Multi_domain_Gate, Multi_domain_FeedForwardNetwork_v3
...
class Multi_domain_SelfAttentionDecoder_v6(Decoder):
  ...
  def __init__(self,
    ...
    self.multi_domain_layers = [
        multi_domain_adapter_class(num_units, num_domain_units, num_units, domain_numb=num_domains, name="ADAP_%d"%i)
        if not isinstance(multi_domain_adapter_class, Multi_domain_SelfAttentionDecoder_v6)
