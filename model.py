...
from utils.my_inputter import My_inputter, Multi_domain_SequenceToSequenceInputter, Multi_domain_SequenceToSequenceInputter_withprob
  ...
  def create_variables(self, optimizer=None):
    ...
    features = tf.nest.map_structure(
        lambda spec: tf.fill(
            ...
            tf.constant("0.0" if spec.dtype is tf.string else 1, dtype=spec.dtype)),
