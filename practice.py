...
def main():
  ...
  learning_rate = onmt.schedules.ScheduleWrapper(schedule=optimizer.schedules.NGDDecay(scale=config.get("learning_rate",1.0), model_dim=config.get("d_model",512), warmup_steps=warmup_steps), step_duration= config.get("step_duration",16))
