...
def main():
  ...
  parser.add_argument("run", choices=["train", "trainv3", "trainv2", "translate", "translatev2", "translatev3", "debug","metatrainv1", "metatrainv2", "metatrainv3", "inspect", "metatrainv5", "metatrainv6", "metatrainv7", "metatrainv8", "finetune"], help="Run type.")
